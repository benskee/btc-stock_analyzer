...
# page = requests.get('https://www.nasdaq.com/api/v1/historical/AMZN/stocks/2019-05-03/2020-08-05')
# df = pd.read_csv('HistoricalQuotes.csv')
# https://www.nasdaq.com/api/v1/historical/BTC/crypto/2020-07-06/2020-08-06
def generate_graph():
